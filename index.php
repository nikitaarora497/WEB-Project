...
<head>
	<title>Be You a Beauty Salon at home</title>
	<!-- Meta Tags -->
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<meta name="keywords" content="Beauty Salon  parlour home salon services" />
		...
		<header>
			<div class="container">
				<div class="header-bottom-agileits">
					<div class="w3-logo">
						<h1><a href="index.php">Be You</a></h1>
					</div>
					<div class="address">
						<p>4th block,banglore.</p>
					...
					<div class="nav-contact-w3ls">
						...
						<p class="para-y"><a href="#">beyou.com</a><span class="fa fa-envelope-o" aria-hidden="true"></span></p>
					</div>
			...
			<nav class="navbar navbar-default shift">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a class="active" href="signup.php">Sign Up<a class="active" href="Login.php">Login</li>				
					</ul>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<h5>Everyone give attention</h5>
					<p> way to glam up your day, here are 20 of the best beauty quotes of all time from some of our favorite beauty pros, style icons.</p>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="area-main">
				<div class="col-md-6 area-inner">
					...
					<div class="area-right p1">
						<h5>FACIAL</h5>
						<p class="para-w3-agile">Nourishing and relaxing — our facials include cleansing, exfoliation, facial massage, masque, hydration and extractions..</p>
						<a href="https://dbksalon.com/services/york-mills/" class="button">View Services</a>
					</div>
				</div>
				<div class="col-md-6 area-inner">
					<div class="area-img2">
					...
					<div class="area-right p2">
						<h5>MAKEUP</h5>
						<p class="para-w3-agile">Our customized organic facial with additional masques, an eye and lip treatment and Hungarian massage..</p>
						<a href="https://dbksalon.com/services/york-mills/" class="button">View Services</a>
			...
			<div class="area-main">
				<div class="col-md-6 area-inner">
					<div class="area-right p3">
						<h5>NAIL CARE</h5>
						<p class="para-w3-agile">Nail shaping, buffing, cuticle work, hand massage and polish..</p>
						<a href="https://dbksalon.com/services/york-mills/" class="button">View Services</a>
				...
				<div class="col-md-6 area-inner">
					<div class="area-right p4">
						<h5>HAIR CARE</h5>
						<p class="para-w3-agile">Everything HairCare Shampoo, Conditioner, and Color. And of course - the dream of beautiful hair!.</p>
						<a href="https://dbksalon.com/services/york-mills/" class="button">View Services</a>
					</div>
					<div class="area-img4">
					</div>
...
<div class="modal-dialog form-dark" role="document">
  ...
  <!--/.Content-->
	...
	<div class="wthree-mid jarallax">
		<div class="container">
			<h3>GetLook is one of the Best Home Salon and Spa Services which brings Best Beauty Professionals at your home and provides beauty services at home</p>
			<div class="botton">
...
and skin care services will suit every beauty need.</p>
			...
			<div id="owl-demo" class="owl-carousel text-center clients-right">
				<div class="item g1">
					...
					<div class="clearfix"></div>
					<p class="para-w3-agile"><span class="fa fa-quote-left" aria-hidden="true"></span>so amazing! I never ended up doing
						 a trial with her!
				...
				<div class="item g1">
					...
					<img class="lazyOwl" src="images/c3.jpg" alt="" />
					<div class="clearfix"></div>
					<p class="para-w3-agile"><span class="fa fa-quote-left" aria-hidden="true"></span>It's easy to lose 
						sight of the end goal when your in the thick of it, so we decided 
						to take some time and round up quotes from people who just get .</p>
				</div>
			</div>
			<!--// Owl-Carousel -->
		</div>
		...
		<div class="col-md-4 w3layouts_footer_grid">
					<h2>Contact <span>Information</span></h2>
					    <ul class="con_inner_text">
							<li><span class="fa fa-map-marker" aria-hidden="true"></span>1234k Avenue, 4th block, <label> Banglore City.</label></li>
							<li><span class="fa fa-envelope-o" aria-hidden="true"></span> <a href="#">beyou.com</a></li>
			...
			<p style='text-align:left;'>Copyright (c) 2020 <a href='#'>Be You</a> All Right Reseved</p>
